...
import kr.ac.hallym.seoseuofolio.databinding.ActivityDmMainBinding
import kr.ac.hallym.seoseuofolio.databinding.ActivityStudyMainBinding

class DmMainActivity : AppCompatActivity() , OnNavigationItemSelectedListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val binding = ActivityDmMainBinding.inflate(layoutInflater)
        ...
        val adapter = DmFragementPagerAdapter(this)
...
class DmFragementPagerAdapter(activity: FragmentActivity): FragmentStateAdapter(activity) {
    val fragment:List<Fragment>
    init {
        fragment = listOf(DmFragment())
    }
