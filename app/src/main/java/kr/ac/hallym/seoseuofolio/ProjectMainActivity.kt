...
class ProjectMainActivity : AppCompatActivity() , OnNavigationItemSelectedListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val binding = ActivityProjectMainBinding.inflate(layoutInflater)
        ...
        val adapter = ProjectFragementPagerAdapter(this)
...
class ProjectFragementPagerAdapter(activity: FragmentActivity): FragmentStateAdapter(activity) {
    val fragment:List<Fragment>
    init {
        fragment = listOf(ProjectFragment())
    }
