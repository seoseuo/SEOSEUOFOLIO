...
class StudyMainActivity : AppCompatActivity() , OnNavigationItemSelectedListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val binding = kr.ac.hallym.seoseuofolio.databinding.ActivityStudyMainBinding.inflate(layoutInflater)
        ...
        val adapter = StudyFragementPagerAdapter(this)
...
class StudyFragementPagerAdapter(activity: FragmentActivity): FragmentStateAdapter(activity) {
    val fragment:List<Fragment>
    init {
        fragment = listOf(StudyOneFragment(),StudyTwoFragment())
    }
